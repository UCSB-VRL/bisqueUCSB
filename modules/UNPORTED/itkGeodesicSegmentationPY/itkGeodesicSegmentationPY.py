...
class itkGeodesicSegmentationPY:
    ...
    def processImage(self):        
        ...
        if int(self.image.z) == 1  and  int(self.image.t) == 1 and (int(self.image.ch) ==1 or int(self.image.ch) == 3):
			...
			tempinfile = 'ac_in.png' # code fails with tiff format
    ...
    def main(self, client_server, image_url,seedX, seedY, Sigma, SigmoidAlpha, SigmoidBeta, PropagationScaling, user=None, password=None):
		...
		self.PropagationScaling = float(PropagationScaling)
