...
THREE.AnaglyphEffect = function ( renderer, width, height ) {
	...
	this.render = function ( scene, camera ) {
		...
		_cameraL.position.copy( camera.position ).applyMatrix4( eyeLeft );
	    //_cameraL.position.x -= 100*eyeSep;
		...
		_cameraR.position.copy( camera.position ).applyMatrix4( eyeRight );
        //_cameraR.position.x += 100*eyeSep;
