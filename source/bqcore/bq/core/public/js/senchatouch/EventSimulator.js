...
ExtTouch.util.EventSimulator = ExtTouch.ExtTouchend(Object, {
    ...
    getEventTypeByName: function(name) {
        ...
        ExtTouch.iterate(this.supportedEvents, function(type, events) {
    ...
    createTouchEventData: function(type, target, options, serializable) {
        ...
        if (options) {
            ExtTouch.iterate(touchEventData, function(key, value) {
    ...
    createTouchList: function(data, target, serializable) {
        ...
        if (ExtTouch.isObject(data) && typeof data.target != 'undefined') {
            data = [data];
        }
    ...
    createMouseEventData: function(type, target, options, serializable) {
        ...
        if (options) {
            ExtTouch.iterate(mouseEventData, function(key, value) {
                if (options.hasOwnProperty(key)) {
