...
% Then checks to make sure that the snake points are within the image
% boundaries and not too far from the top/bottom boundaries.  Finally
% resample the snake points to make them uniformly spaced apart.
%
% INPUT:
