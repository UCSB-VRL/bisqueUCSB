function [truth, false_negative, false_positive, precision, recall, false_alarm_rate] = f_discrepancy(segmentation_result, ground_truth)
...
%
%   recall = recall of each layer  %==HIT RATE IN ROC CURVE ==sensitivity
%
%  false_alarm_rate= false positive fraction of each layer  ==1-specificity
...
false_alarm_rate = zeros(1, layers);
...
for i = 1:layers,
    ...
    false_alarm_rate(i)=false_positive(i)/(gt_sum);
