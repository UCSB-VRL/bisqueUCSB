% SCRIPT test_datatypes
% returns a structure with datatypes into a workspace
% variable called "mdatatypes".
%
% double char struct cell complex sparse logical single
