function [P,im_test,prof_train]=f_example(x_in,current_layer,test_image,train_image,pts_orig,r,c,z)
...
%clear all;
%clear C P P_raw P_train R Vel c dp dp_train ds f_damp f_ext f_ext_g f_ext_r f_int f_total gweight im im_buffer im_test k lay len_prof len_prof_pix n_samp np p_acc p_damp p_mass p_vel p_vel_min prof_test prof_train prof_train_all pts_orig r sig_eff sig_w_pix w_ext w_g w_int w_r x_in y_in z;
...
%eval(['load ' load_name ' pts_orig r c z']);

% We will be finding the border of the ONL and IS.
lay = current_layer; %2; % 1: GCL/bg, 2: OS/bg, 3: INL/ONL, 4: ONL/IS, 5: GCL/INL
